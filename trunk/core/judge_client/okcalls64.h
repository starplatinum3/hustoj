 ...
 */
//c & c++
int LANG_CV[CALL_ARRAY_SIZE] = {0,1,2,3,4,5,8,9,11,12,20,21,59,63,89,99,133,158,231,240,257,272,273,275,511, SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
